...
- `0.1.6-alpha.1` 复核（2026-09-15）：**循环层 10 个探针全部原行号命中，一字未改**；只有 `dsh-tool-fs` 的两个码下移 6 行（`:547-548` → `:541-542`）。见 `docs/status/dsh-0.1.6-alpha.1-update-readiness-2026-09-15.md`
